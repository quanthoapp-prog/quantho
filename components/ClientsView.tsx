        ...
        <div className="space-y-6">
            ...
            {showAddClient && (
                <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-blue-200">
                    <h3 className="text-lg font-bold mb-4 text-blue-700">Aggiungi cliente</h3>
                    ...
                    <div className="flex gap-2 mt-6">
                        ...
                        <button onClick={() => setShowAddClient(false)} className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg font-semibold hover:bg-gray-300 transition-colors">Annulla</button>
                    </div>
                </div>
            )}
